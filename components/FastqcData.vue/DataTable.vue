                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <button
                                                class="px-4 py-2 font-semibold text-sm bg-gray-500 text-white rounded-full shadow-sm cursor-not-allowed"
                                            >
                                                Tumor
                                            </button>
                                        </div>
                                        ...
                                        >
                                            <button
                                                class="px-2 py-2 font-semibold text-sm bg-gray-500 text-white rounded-full shadow-sm cursor-not-allowed"
                                            >
                                                Normal
                                            </button>
                                            <button
                                    ...
                                    >
                                        <button
                                            :class="
                                                event.RNA.Normal
                                                    ? 'px-2 py-2 font-semibold text-sm bg-red-500 text-white rounded-full shadow-sm'
                                                    : 'px-4 py-2 font-semibold text-sm bg-gray-500 text-white rounded-full shadow-sm cursor-not-allowed'
                                            "
                                        >
                                            Normal
                                        </button>
